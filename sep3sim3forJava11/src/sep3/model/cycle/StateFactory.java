...
public class StateFactory extends Factory<Integer, State> {
	...
	public StateFactory() {
		...
		makeItem(Integer.valueOf(SC_FF0), new FetchFrom0());
		makeItem(Integer.valueOf(SC_FF1), new FetchFrom1());
		makeItem(Integer.valueOf(SC_FF2), new FetchFrom2());
		makeItem(Integer.valueOf(SC_TF0), new FetchTo0());
		makeItem(Integer.valueOf(SC_TF1), new FetchTo1());
	}
